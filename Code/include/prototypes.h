...
//in file alarmdriver.c
extern uint32 devread(uint32);
extern bool8 devwrite(uint32, uint32);
extern bool8 devinit(uint32);

//in file alarmmsgq.c
extern syscall sendalarmmsg(struct alarmmsg *);

//in file communication.c
extern int32 sendmsg(uint32, uint16, char *);
