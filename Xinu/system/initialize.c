...
extern	process temperature(void);
extern	process receivemsg(void);
...
local process	startup(void)
{
	...
	//create temperature process
	resume(create(temperature, INITSTK, 100, "Temperature Process", 0, NULL));
	//create receive message process
	resume(create(receivemsg, INITSTK, 100, "Receive Alarm", 0, NULL));
